...
\begin{description}
  ...
  \item[\texttt{\textbackslash mainadvisor\{<name>\}\{<department>\}}] \textbf{Required}. Main supervisor 
    and department affiliation.
  \item[\texttt{\textbackslash coadvisor\{<name>\}\{<department>\}}] \textbf{Required}. Additional 
    supervisor and department affiliation.
  \item[\texttt{\textbackslash examiner\{<name>\}\{<department>\}}] \textbf{\texttt{mscthesis} only}. 
