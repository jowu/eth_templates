...
\usepackage{cleveref}
\usepackage[edit]{editing}

\frenchspacing

\title{The \texttt{editing} Package}
...
\begin{abstract}
The \texttt{editing} package provides custom macros for document editing and acronym handling. 
...
The \texttt{editing} package extends \LaTeX{} with utilities designed to improve document editing workflows:
\begin{itemize}
...
\begin{verbatim}
\usepackage{editing}  % Remove [edit] here
\end{verbatim}
...
\begin{enumerate}
  ...
  \item \verb|editing| (after \verb|cleveref|)
\end{enumerate}

\textbf{Important:} \verb|cleveref| must load before \verb|editing|, as the editing 
...
\begin{verbatim}
\usepackage[edit]{editing}  % Not: \usepackage{editing}
\end{verbatim}
...
\begin{itemize}
  \item \verb|cleveref| is loaded before \verb|editing|
...
\begin{table}
  ...
  \begin{tabular}{lcc}
    ...
    Reference highlighting (\verb|\cref|, \verb|\Cref|) & & \checkmark \\
    Range reference highlighting (\verb|\crefrange|, \verb|\Crefrange|) & & \checkmark \\
